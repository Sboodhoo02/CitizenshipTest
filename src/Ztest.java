...
public class Ztest {
    ...
    public static void prePreparation(List<Exam> exams){
        ...
        // q.addHint("", "", "");
        q2.addHint("sets up the government", " defines the government", "protects basic rights of Americans");
        q4.addHint("A change (to the Constitution)", "An addition (to the Constitution)");
        q6.addHint("Speech", "Religion", "Assesmbly", "Press", "Petition the Government");
        ...
        q45.addHint("Democratic", "Republican");
